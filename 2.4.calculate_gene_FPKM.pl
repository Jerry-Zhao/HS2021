...
open(INGENOMEP,"/media/Project/Genome/Ensembl_100/exon_intron/Mus_musculus.GRCm38.100.gtf_plus_final.exon")||die("Can't open INGENOMEP:$!\n");
open(INGENOMEM,"/media/Project/Genome/Ensembl_100/exon_intron/Mus_musculus.GRCm38.100.gtf_minus_final.exon")||die("Can't open INGENOMEM:$!\n");
open(OUT,">FPKM/FPKM_$name\_ExonicGene.xls")||die("Can't write OUT:$!\n");
